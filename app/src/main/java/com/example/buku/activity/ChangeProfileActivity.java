...
public class ChangeProfileActivity extends AppCompatActivity {
    ...
    // pembatasan buat jumlah no telepon
    ...
    public void SAVE_BTN(View view){
        ...
        if (! (telepon_PATTERN).matcher(hape).matches()) {
            ...
            // progress dialog dulu bos biar keren
            ...
            StringRequest request = new StringRequest(Request.Method.POST, Constant.URL_UPDATE,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            catch (JSONException jsonObject) { // ketika eror dia akan ngeprint dimana jsonobjectnya eror
                                jsonObject.printStackTrace();
                            }
                        }
                    }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) { // jika eror toast akan keluar tulisan fail to update data
