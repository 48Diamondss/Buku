...
public class Session {
    ...
    public boolean userlogin (String  id, String namee, String email, String nohp ){
        ...
        /** jadi kalo login, data yang masuk di session ya
         *  id, name, email, nohp
         */
    ...
    public boolean userUpdated (String nohp ){ // u[date nomer hape ae
...
//        editor.putString(KEY_EMAIL, email);
    ...
    public boolean isLoggedin (){ // pengecekan apabilauser udah login apa lom
        SharedPreferences sharedPreferences = ctx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
    ...
    public boolean logout (){ // digunakan untuk log out dri session
    ...
    /**
     * dibawah ini digunakan untuk mengambil data jadi di get apa datanya, lalu rertunr apa yang diminta dari session yang
     * udah di insert sebelumnyaaa
     * @return
     */
